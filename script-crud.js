// class da ul que vai receber as li das listas de tarefas
const taskListContainer = document.querySelector('.app__section-task-list');

const formTask = document.querySelector('.app__form-add-task');
const alternarTaskBtn = document.querySelector('.app__button--add-task');
...
/**************************************************************************************
 * CONST FUNCTION SLECIONATAREFA
 **************************************************************************************/
const selecionaTarefa = (tarefa, elemento) => {
   if(tarefa.concluida){
        return;
   }
   // caso a tarefa ja estiver concluida nao seleciona a tarefa para dar foco
...
} // fim const selecionaTarefa

/**************************************************************************************
 * CONST FUNCTION LIMPA FORM
 **************************************************************************************/
const limparForm = () => {
    tarefaEmEdicao = null;
    paragraphEmEdicao = null;
    textArea.value = '';
    formTask.classList.add('hidden'); // esconde o form addtarefa
}

/**************************************************************************************
 * CONST FUNCTION SELECIONATAREFAPARAEDITAR
 **************************************************************************************/
...
function createTask(tarefa){
    ...
    button.classList.add('app_button-edit'); // CRIA O BOTAO DE EDIÇÃO
  //  button.innerHTML = ' <img src="/imagens/edit.png" alt="">'
  // esse código acima funcionou mas vou usar o código do prof que 
  // tb funciona e acho que vai ser melhor para o projeto final

// código para colocar a imagem no button
...
alternarTaskBtn.addEventListener('click', () =>{
    formLabel.textContent = 'Adicionando Tarefa';
    formTask.classList.toggle('hidden'); // retira a propriedade hiden do form de addtarefa
    // assim o form que estav escondido aparece
})

// salva a tarefa no localStorage cm a key = tarefas e o conteúdo JSON.stringify(tarefas) que
// é o array das tarefas
const updateLocalStorage = () => {
    localStorage.setItem('tarefas', JSON.stringify(tarefas))
}

/**************************************************************************************
 * FORMTASK EVENT SUBMIT
 **************************************************************************************/
